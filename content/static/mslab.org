...
I did my master's thesis in MSLab under the supervision of Dr. Miguel Angel Otaduy.
...
The full text of the work can be found [[file:resources/tfm.pdf][here]].
Also I have written a small post about differentiable simulation and a web demo [[file:differential_simulation.org][here]].
